...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { amount_people: @concert.amount_people, date: @concert.date, group: @concert.group, spot: @concert.spot } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { amount_people: @concert.amount_people, date: @concert.date, group: @concert.group, spot: @concert.spot } }
